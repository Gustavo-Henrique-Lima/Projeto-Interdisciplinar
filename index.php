...
<html lang="pt-br">
  <head>
    ...
    <link
      rel="stylesheet"
      href="FrontEnd/node_modules/bootstrap/dist/css/bootstrap.css"
    />
    <!--Adicionando o Css-->
  ...
  <body class="bgImage">
      ...
      <div class="row tamcontainer">
        ...
        <div class="col-lg bg-white controlScreenIndex">
          ...
          <a
            ...
            href="FrontEnd/Html/pag_login_docente.php"
            >DOCENTE</a
          >
          <br /><br />
          <a class="btn btnLogin btn-outline-primary btnSize" href="FrontEnd/Html/pag_login_discente.php"
            >DISCENTE</a
          >
        </div>
      </div>
    ...
    <script src="FrontEnd/node_modules/bootstrap/dist/js/bootstrap.js"></script>
    <!--Script Local-->
    <script src="FrontEnd/myScript/script.js"></script>
  </body>
</html>